...
function ($stateProvider, $urlRouterProvider, $controllerProvider, $compileProvider, $filterProvider, $provide, $ocLazyLoadProvider, jsRequires) {
    ...
    $urlRouterProvider.otherwise("/app/search_for_restaurant");
    //
    // Set up the states
    $stateProvider.state('app', {
        url: "/app",
        templateUrl: "assets/views/app.html",
        resolve: loadSequence('chartjs', 'chart.js', 'chatCtrl', 'authSer', 'sessionSer'),
        abstract: true
    }).state('app.dashboard', {
        url: "/dashboard",
    ...
    }).state('app.search_for_restaurant', {
        url: '/search_for_restaurant',
        templateUrl: "assets/views/search_for_restaurant.html",
        title: 'Search For Restaurant',
        ncyBreadcrumb: {
            label: 'Search For Restaurant'
        },
        resolve: loadSequence('searchForRestaurantCtrl', 'dataSer', 'authSer', 'sessionSer', 'httpQueriesFac')
    }).state('app.contactus', {
        url: '/contuct_us',
        templateUrl: "assets/views/contact_us.html",
        title: 'Contuct Us',
        ncyBreadcrumb: {
            label: 'Contuct Us'
        }
