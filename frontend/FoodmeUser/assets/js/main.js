...
function ($rootScope, $state, $stateParams) {
    ...
    $rootScope.app = {
        name: 'Food Me', // name of your project
...
app.config(function(FacebookProvider) {
	...
	FacebookProvider.init({
		appId      : '817050055094155', // my app id
...
app.config(function ($breadcrumbProvider) {
    $breadcrumbProvider.setOptions({
        template: '<ul class="breadcrumb"><li><a ui-sref="app.search_for_restaurant"><i class="fa fa-home margin-right-5 text-large text-dark"></i>Food Me</a></li><li ng-repeat="step in steps">{{step.ncyBreadcrumbLabel}}</li></ul>'
    });
});
// ng-storage
