...
app.constant('JS_REQUIRES', {
    ...
    scripts: {
        ...
        /*--------------------------------------------------Custom----------------------------------------------------*/
        'addRestaurantCtrl': 'assets/js/controllers/addRestaurantCtrl.js',
        'addMenuCtrl': 'assets/js/controllers/addMenuCtrl.js',
        'ordersCtrl': 'assets/js/controllers/ordersCtrl.js',
        //***Services/Factories
        'httpQueriesFac': 'assets/js/services-factories/httpQueriesFac.js',
        'dataSer': 'assets/js/services-factories/dataSer.js',
        'authSer': 'assets/js/services-factories/authSer.js',
        'sessionSer': 'assets/js/services-factories/sessionSer.js'
    },
    //*** angularJS Modules
    modules: [{
        name: 'toaster',
